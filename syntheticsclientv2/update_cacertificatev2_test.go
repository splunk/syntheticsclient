...
func TestUpdateCaCertificateV2ReturnsErrorOnMalformedResponse(t *testing.T) {
	setup()
	defer teardown()
...
func TestUpdateCaCertificateV2ReturnsErrorWhenRequestFails(t *testing.T) {
	...
	_, _, err = unreachableClient.UpdateCaCertificateV2(1, &inputCaCertificateV2Update)
...
func TestUpdateCaCertificateV2HandlesEmptyResponseBody(t *testing.T) {
	setup()
	defer teardown()
