...
func TestCreateSslCheckV2ReturnsErrorOnMalformedResponse(t *testing.T) {
	setup()
	defer teardown()
...
func TestCreateSslCheckV2ReturnsErrorWhenRequestFails(t *testing.T) {
	...
	_, _, err = unreachableClient.CreateSslCheckV2(&inputSslCheckV2Data)
