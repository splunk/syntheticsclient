...
func TestGetClientCertificatesV2ReturnsErrorOnMalformedResponse(t *testing.T) {
	setup()
	defer teardown()
...
func TestGetClientCertificatesV2ReturnsErrorWhenRequestFails(t *testing.T) {
	...
	_, _, err := unreachableClient.GetClientCertificatesV2()
