...
func TestDeleteClientCertificateV2ReturnsErrorOnNon2xxStatus(t *testing.T) {
	setup()
	defer teardown()
...
func TestDeleteClientCertificateV2ReturnsErrorWhenRequestFails(t *testing.T) {
	...
	_, err := unreachableClient.DeleteClientCertificateV2(123)
